$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Generson and Elmie's Wedding",

            // Event start date
            start: new Date('April 9, 2022 16:00'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('April 9, 2022 21:00'),

            // Event Address
            address: 'One Feather Kitchen, Silang Cavite',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbzwbFW4GP4sVlvZMOW4WIqoVxBQThUDbj96p4kCSvBQOa4TQJKrWp_WsBBHWqCi3zdzdg/exec', data)
            .done(function (data) {
                console.log(data);
